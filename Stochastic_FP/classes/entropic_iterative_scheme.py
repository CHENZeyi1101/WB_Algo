...
class entropic_iterative_scheme:
    ...
    def converge(self, source_measure_samples, input_measure_samples, iter, num_samples = 5000, max_iter = 20, epsilon = 1, plot = True, scatter = False):
        ...
        # source_sampler_info = source_sampler.__dict__
        # source_sampler_info = {
        #     "dim": dim,
        ...
        # entropic_sampler_info = entropic_sampler.__dict__

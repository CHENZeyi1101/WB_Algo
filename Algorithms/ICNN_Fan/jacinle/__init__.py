...
.. autosummary::
    ...
    ~jacinle.utils.printing.print_filedoc
...
.. autosummary::
    ...
    ~jacinle.utils.debug.lf_indent_log
    ~jacinle.utils.debug.lf_indent_print
...
if jac_getenv('IMPORT_ALL', 'true', 'bool'):
    ...
    from jacinle.utils.printing import colored, indent_text, stprint, stformat, kvprint, kvformat, print_to_string, print_to, suppress_stdout, suppress_stderr, suppress_output, tabulate_dataclass, print_filedoc

...
cfg.MEAN, cfg.COV = select_mean_and_cov(cfg.TRIAL)
cfg.INPUT_DIM = cfg.MEAN[0].shape[1]
cfg.OUTPUT_DIM = cfg.INPUT_DIM
cfg.NUM_DISTRIBUTION = len(cfg.MEAN)
for i in range(cfg.NUM_DISTRIBUTION):
    cfg.NUM_GMM_COMPONENT.append(cfg.MEAN[i].shape[0])
if cfg.INPUT_DIM <= 2:
    cfg.high_dim_flag = False
else:
    cfg.high_dim_flag = True
...
"""""""""""""""""""""""""""""""""""""""""""""""""""
                        Data
"""""""""""""""""""""""""""""""""""""""""""""""""""
total_data = g_data.marginal_data_gmm_3loop_ficnn(cfg)

...
if __name__ == "__main__":
    ...
    true_v_OT_path = f"{cfg_dict['outputs_dir']}/fullpost_V_value/fullpost_V_values.json"
    assert os.path.exists(true_v_OT_path), f"True V value file {true_v_OT_path} does not exist."
    ...
    plot_v_values(v_values_path, true_v_OT_path=true_v_OT_path, plot_dir=plot_dir, plot_name="V_values_iters")
